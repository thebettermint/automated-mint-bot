...
function convertOrderChange(order:any) {
...
function rippleToUnixTimestamp(rpepoch:any) {
  return (rpepoch + 0x386D4380) * 1000
}

function getExpirationTime(node:any) {
...
function parseOrderStatus(node:any) {
...
function calculateDelta(finalAmount:any, previousAmount:any) {
  if (previousAmount) {
...
function parseChangeAmount(node:any, type:string) {
...
function parseOrderChange(node:any) {
...
function groupByAddress(orderChanges:any) {
 ...
 *
 */
function parseOrderbookChanges(metadata:any) {
